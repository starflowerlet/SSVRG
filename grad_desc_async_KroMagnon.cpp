...
chrono::steady_clock::time_point start_SVRG = chrono::steady_clock::now();
...
std::vector<double>* grad_desc_async_sparse::KroMagnon_Async(double* X
    ...
    if(is_store_result) {
		...
		chrono::duration<double>time_used = chrono::duration_cast<chrono::duration<double>>(end - start_SVRG);
